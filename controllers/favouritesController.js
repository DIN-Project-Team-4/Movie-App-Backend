const { toggleFavourite, getFavouritesByUser } = require("../models/favouritesModel.js"); // Adjust imports based on your model structure
...
const getFavourites = async (req, res) => {
    ...
    try {
        const favourites = await getFavouritesByUser(userId); // Fetch favourites from your model
...
const toggleFavouriteMovie = async (req, res) => {
    ...
    try {
        const result = await toggleFavourite(movieId, userId, movieName); // Toggle favourite using your model
